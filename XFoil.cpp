...
bool XFoil::bldif(int ityp) {
  ...
  if (ityp == 0) {
    ...
    if (ityp == 1) {
      ...
      vsm[1] += z_cq1 * blData1.cqz_ms + z_cf1 * blData1.cfz_ms + z_hk1 * blData1.hkz_ms +
...
bool XFoil::trdif() {
  ...
  double wf2 = (xt - blData1.xz) / (blData2.xz - blData1.xz);
  double wf2_xt = 1.0 / (blData2.xz - blData1.xz);

  double wf2_a1 = wf2_xt * xt_a1;
  double wf2_x1 = wf2_xt * xt_x1 + (wf2 - 1.0) / (blData2.xz - blData1.xz);
  double wf2_x2 = wf2_xt * xt_x2 - wf2 / (blData2.xz - blData1.xz);
