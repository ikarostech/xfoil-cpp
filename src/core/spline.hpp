...
class spline {
public:
  static double seval(double ss, Eigen::VectorXd x, Eigen::VectorXd xs,
   ...
   * -------------------------------------------------- */
  static double deval(double ss, Eigen::VectorXd x, Eigen::VectorXd xs,
                      Eigen::VectorXd s, int n);
   ...
   *      xs array must have been calculated by spline    /
   * --------------------------------------------------- */
  static double d2val(double ss, Eigen::VectorXd x, Eigen::VectorXd xs,
                      Eigen::VectorXd s, int n);

  static double sinvrt(double si, double xi, Eigen::VectorXd x,
                       Eigen::VectorXd xs, Eigen::VectorXd s, int n);
