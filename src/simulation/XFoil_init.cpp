...
void XFoil::initializeDataStructures() {
  ...
  boundaryLayerWorkflow.lattice.top.sideState.ctau.setZero();
  boundaryLayerWorkflow.lattice.bottom.sideState.ctau.setZero();
  boundaryLayerWorkflow.lattice.top.ctq.setZero();
  boundaryLayerWorkflow.lattice.bottom.ctq.setZero();
  boundaryLayerWorkflow.lattice.top.sideState.dstr.setZero();
  boundaryLayerWorkflow.lattice.bottom.sideState.dstr.setZero();
  boundaryLayerWorkflow.lattice.top.sideState.thet.setZero();
  boundaryLayerWorkflow.lattice.bottom.sideState.thet.setZero();
  boundaryLayerWorkflow.lattice.top.sideState.uedg.setZero();
  boundaryLayerWorkflow.lattice.bottom.sideState.uedg.setZero();
  boundaryLayerWorkflow.lattice.top.xssi.setZero();
  boundaryLayerWorkflow.lattice.bottom.xssi.setZero();
  boundaryLayerWorkflow.lattice.top.uinv.setZero();
  boundaryLayerWorkflow.lattice.bottom.uinv.setZero();
  boundaryLayerWorkflow.lattice.top.uinv_a.setZero();
  boundaryLayerWorkflow.lattice.bottom.uinv_a.setZero();
  boundaryLayerWorkflow.lattice.top.sideState.mass.setZero();
  boundaryLayerWorkflow.lattice.bottom.sideState.mass.setZero();
  boundaryLayerWorkflow.lattice.top.vti.setZero();
  boundaryLayerWorkflow.lattice.bottom.vti.setZero();
