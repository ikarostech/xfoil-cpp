...
void XFoil::initializeDataStructures() {
  ...
  boundaryLayerWorkflow.lattice.top.ctau.setZero();
  boundaryLayerWorkflow.lattice.bottom.ctau.setZero();
  boundaryLayerWorkflow.lattice.top.ctq.setZero();
  boundaryLayerWorkflow.lattice.bottom.ctq.setZero();
  boundaryLayerWorkflow.lattice.top.dstr.setZero();
  boundaryLayerWorkflow.lattice.bottom.dstr.setZero();
  boundaryLayerWorkflow.lattice.top.thet.setZero();
  boundaryLayerWorkflow.lattice.bottom.thet.setZero();
  boundaryLayerWorkflow.lattice.top.uedg.setZero();
  boundaryLayerWorkflow.lattice.bottom.uedg.setZero();
  ...
  boundaryLayerWorkflow.lattice.top.mass.setZero();
  boundaryLayerWorkflow.lattice.bottom.mass.setZero();
