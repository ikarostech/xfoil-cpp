...
bool XFoil::trdif() {
  ...
  blc = bldif(FlowRegimeEnum::Laminar, boundaryLayerState, laminarSkinFriction, amcrit);
  ...
  blc = bldif(FlowRegimeEnum::Turbulent, boundaryLayerState, turbulentSkinFriction, amcrit);
