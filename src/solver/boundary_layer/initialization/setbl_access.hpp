...
class BoundaryLayerSetblAccess {
  public:
    explicit BoundaryLayerSetblAccess(BoundaryLayer &boundaryLayer) : boundaryLayer_(boundaryLayer) {}
    ...
    int stationCount(int side) const {
        return boundaryLayer_.stationCount(side);
    }
    int trailingEdgeIndex(int side) const {
        return boundaryLayer_.trailingEdgeIndex(side);
    }
    int topTrailingEdgeIndex() const {
        return trailingEdgeIndex(1);
    }
    int bottomTrailingEdgeIndex() const {
        return trailingEdgeIndex(2);
    }
    int transitionIndex(int side) const {
        return boundaryLayer_.transitionIndex(side);
    }
    ...
    int leadingEdgePanelIndex(int side) const {
        return stationToPanel(side, 0);
    }
    ...
    BoundaryLayerSideState &profiles(int side) {
        return boundaryLayer_.profiles(side);
    }
    ...
    BlTransitionParams &blTransition() const {
        return boundaryLayer_.transition();
    }
    int systemSize() const {
        return boundaryLayer_.systemSize();
    }
    ...
    void runTransitionCheck() const {
        boundaryLayer_.runTransitionCheck();
    }
    double currentAmplification() const {
        return boundaryLayer_.currentAmplification();
    }
    double previousAmplification() const {
        return boundaryLayer_.previousAmplification();
    }
    double currentSkinFrictionHistory() const {
        return boundaryLayer_.currentSkinFrictionHistory();
    }
    BoundaryLayerStationWindow snapshotState() const {
        return boundaryLayer_.snapshotState();
    }
    void replaceState(const BoundaryLayerStationWindow &state) const {
        boundaryLayer_.replaceState(state);
    }
    void advanceState() const {
        boundaryLayer_.advanceState();
    }
